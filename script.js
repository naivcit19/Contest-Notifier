...
var xx=tex.search("Current or upcoming contests");
var tt=tex.search("Past contests");
var sx=tex.substring(xx,tt);
...
if(xx<0) xx=tex.search("Present Contests");
...
var img = document.createElement('img');
    ...
    //  img.setAttribute('width', 200);
     document.body.appendChild(img);
	 var link="http://www.codechef.com/contests";
var div = document.createElement('div');   
div.innerHTML = '<a href="'+link+'" target="_blank">Visit</a>';
 document.body.appendChild(div);
...
ss.push("http://community.topcoder.com/"+anchors[0].getAttribute("href"));
	  ...
	  ss.push(dt+'/'+mm+'/'+yyyy);
	  ss.push((str).match(/\d{2}\:\d{2}/g)+" (EDT)");
